          ...
          <div class="bg-white rounded-lg shadow-xl p-8 md:p-12">
            ...
            <div class="grid md:grid-cols-3 gap-6">
              <a
                ...
                class="flex flex-col items-center p-6 bg-gray-50 rounded-lg hover:bg-accent hover:text-white transition transform hover:-translate-y-2"
              >
                <svg class="w-12 h-12 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <h3 class="font-bold text-lg mb-2">Email</h3>
                <p class="text-sm text-center break-all">anetohevangeline47&#64;gmail.com</p>
              </a>
              <a
                href="https://github.com/evan246"
                target="_blank"
                class="flex flex-col items-center p-6 bg-gray-50 rounded-lg hover:bg-black hover:text-white transition transform hover:-translate-y-2"
              >
                ...
                <p class="text-sm">github.com/evan246</p>
              </a>
              <a
              ...
              >
                ...
                <p class="text-sm text-center">Connect with me</p>
              </a>
            </div>
          </div>
        </div>
